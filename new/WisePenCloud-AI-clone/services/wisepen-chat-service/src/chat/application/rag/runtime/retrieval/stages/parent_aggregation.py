...
from chat.application.rag.runtime.retrieval.stages.candidate_fusion import RagFusedCandidate
...
class SearchChunkHit:
    """Best child search chunk hit kept during parent aggregation."""
