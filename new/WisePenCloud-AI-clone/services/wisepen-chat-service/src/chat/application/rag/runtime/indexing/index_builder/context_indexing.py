...
from chat.application.rag.runtime.llm_clients.context_client import ContextBuildError, RagContextClient
...
from chat.application.rag.runtime.models import SearchChunkContext
...
class RagContextBuilder:
    ...
    - 任意 SearchChunk 生成 context 失败时，整个索引构建失败并进入队列重试。
