 ...
 *
 * A streaming parsers for ANSI escape sequences that produces semantic actions.
 ...
 * const actions1 = parsers.feed('partial\x1b[')
 * const actions2 = parsers.feed('31mred')  // state maintained internally
 * ```
 */
export class Parser {
