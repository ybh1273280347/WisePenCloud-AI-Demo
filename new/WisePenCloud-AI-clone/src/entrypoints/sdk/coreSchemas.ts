  ...
  z
    .object({
      ...
      apiProvider: z
        ...
        .optional()
        .describe(
          'Active API backend. Anthropic OAuth login only applies when "firstParty"; for 3P llm_clients the other fields are absent and auth is external (AWS creds, gcloud ADC, etc.).',
        ),
    })
