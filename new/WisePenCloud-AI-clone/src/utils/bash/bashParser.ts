/**
 * Pure-TypeScript bash parsers producing tree-sitter-bash-compatible ASTs.
 *
 * Downstream code in parsers.ts, ast.ts, prefix.ts, ParsedCommand.ts walks this
 ...
 * corpus generated from the WASM parsers.
 */
...
/** No-op: pure-TS parsers needs no async init. Kept for API compatibility. */
...
/** Legacy byte-range subscript index parsers — kept for callers that pre-scan. */
...
function parseExpansionRest(
  ...
  // WORD mode: segmenting parsers — recognize nested ${...}, $(...), $'...',
...
/** Precedence-climbing binary expression parsers. */
