...
from chat.application.content_detection.magika_detector import _map_mime_or_extension, _normalize_extension
from chat.application.content_detection.models import ContentDetection, DetectionConfidence
