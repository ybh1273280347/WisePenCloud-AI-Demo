...
from chat.application.content_detection import ContentDetection, ContentDetector, ContentKind, DetectionHints
...
def cache_and_format(**kwargs) -> str:
    from chat.application.tool_content_store import cache_and_format as _cache_and_format
