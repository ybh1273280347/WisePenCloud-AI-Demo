from common.logger import setup_logging_intercept, log_event, log_fail
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        log_fail("Nacos 服务注销", e)

container.wire(modules=[chat_endpoints, session_endpoints, memory_endpoints])  # 注入依赖到路由模块
